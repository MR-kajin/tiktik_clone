        ...
        <div>
          {searchAccounts.length >0 ? (
            searchAccounts.map((user: IUser, idx: number) => (
              ...
              <div className='flex p-2 cursor-pointer font-semibold rounded gap-3 border-b-2 border-gray-200'>
                <div>
                  <Image
                    src={user.image}
                    width={50}
                ...
                <div className='hidden xl:block'>
                  <p className='cursor-pointer flex gap-1 item-center text-md font-bold text-primary lowercase'>
